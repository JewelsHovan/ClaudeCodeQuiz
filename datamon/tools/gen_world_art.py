...
def build_manifest():
    ...
    entries = [
        ...
        member("hd-radiator", "prop", "radiator", "hd-radiator.png", 32, 32, "soft",
               "legacy:props/radiator.png", tile_w=1, tile_h=1, max_colors=48),
